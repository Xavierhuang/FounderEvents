                        ...
                        Button(action: {
                            ...
                            HStack(spacing: 16) {
                                Image(systemName: timeRange.icon)
                                    .font(.title2)
                                    .foregroundColor(selectedTimeRange == timeRange ? .white : .founderAccent)
                                    .frame(width: 30)
                            ...
                            .background(
                                RoundedRectangle(cornerRadius: 12)
                                    .fill(selectedTimeRange == timeRange ? Color.founderAccent : Color(.systemGray6))
                            )
                            .overlay(
                                RoundedRectangle(cornerRadius: 12)
                                    .stroke(selectedTimeRange == timeRange ? Color.founderAccent : Color.clear, lineWidth: 2)
                            )
                        }
                ...
                Button(action: {
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 16)
                            .fill(eventsToShare.isEmpty ? Color.gray : Color.founderAccent)
                    )
                }
        ...
        NavigationView {
            VStack(spacing: 0) {
                ...
                Button(action: onDone) {
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 16)
                            .fill(selectedEvents.isEmpty ? Color.gray : Color.founderAccent)
                    )
                }
        ...
        Button(action: onToggle) {
            HStack(spacing: 16) {
                ...
                Image(systemName: isSelected ? "checkmark.circle.fill" : "circle")
                    .font(.title2)
                    .foregroundColor(isSelected ? .founderAccent : .gray)
            ...
            .background(
                RoundedRectangle(cornerRadius: 8)
                    .fill(isSelected ? Color.founderAccent.opacity(0.1) : Color.clear)
            )
            .overlay(
                RoundedRectangle(cornerRadius: 8)
                    .stroke(isSelected ? Color.founderAccent : Color.clear, lineWidth: 2)
            )
        }
        .buttonStyle(PlainButtonStyle())
    }
