                        ...
                        if dayEvents.isEmpty {
                            VStack(spacing: 20) {
                                Image(systemName: "calendar.badge.plus")
                                    .font(.system(size: 60))
                                    .foregroundColor(.founderAccent.opacity(0.6))
                                    .padding()
                                    .background(
                                        Circle()
                                            .fill(Color.founderAccent.opacity(0.1))
...
struct CalendarDayView: View {
    ...
    var body: some View {
        Button(action: onTap) {
            ...
            .background(
                Circle()
                    .fill(isSelected ? Color.founderAccent : Color.clear)
                    .shadow(color: isSelected ? .founderAccent.opacity(0.3) : .clear, radius: 2, x: 0, y: 1)
            )
        }
